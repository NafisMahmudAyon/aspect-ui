...
export const Input = forwardRef(({ label, type = "text", error, icon = _jsx(Mail, {}), labelClassName = "", iconClassName = "", className = "", wrapperClassName = "", errorClassName = "", passwordIconClassName = "", onChange, ...rest }, ref) => {
