...
export const useToast = () => {
    ...
    const ToastContainer = ({ limit = 5 }) => (_jsx("div", { className: 'fixed right-4 bottom-4 z-[9999] flex flex-col-reverse gap-2', children: _jsx(AnimatePresence, { children: toasts.slice(0, limit).map(toastItem => (_jsx(Toast, { toastId: toastItem.id, ...toastItem, onClose: () => removeToast(toastItem.id) }, toastItem.id))) }) }));
