...
export const Alert = ({ type = 'info', children, closeable = true, onClose, className = '', icon, ...rest }) => {
    ...
    return (_jsxs("div", { className: cn(getAlertStyles(), className), role: 'alert', ...rest, children: [_jsxs("div", { className: 'flex items-center', children: [_jsx("span", { className: `mr-2 ${getIconStyles()}`, children: icon || getIcon() }), _jsx("span", { className: 'block flex-1', children: children })] }), closeable && (_jsx("span", { className: 'absolute top-0 right-0 bottom-0 px-4 py-3', onClick: handleClose, title: 'close', role: 'button', "aria-label": 'close', children: _jsx(X, { className: cn(getCloseStyles()) }) }))] }));
};
