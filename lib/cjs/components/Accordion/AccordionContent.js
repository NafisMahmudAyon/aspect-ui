...
export const AccordionContent = ({ children, isOpen, className = '', ...rest }) => {
    ...
    return (_jsx(AnimatePresence, { initial: false, children: isOpen && (_jsx(motion.div, { initial: 'collapsed', animate: 'open', exit: 'collapsed', variants: {
            ...
            }, transition: { duration: 0.3, ease: [0.04, 0.62, 0.23, 0.98] }, children: _jsx("div", { className: cn('border-border bg-bg overflow-hidden border-t p-4 text-sm', accordionContentClassName, className), ...rest, children: children }) })) }));
};
