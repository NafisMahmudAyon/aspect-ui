...
const Tooltip = ({ children, direction = 'top', showOnClick = false, className = '', arrowColor = '#847ef3', arrowSize = 10, contentClassName = '', actionClassName = '', reset = false, ...rest }) => {
    ...
    return (_jsxs("div", { className: cn('relative inline-block', className), ...rest, children: [_jsx("div", { ref: triggerRef, className: cn('', actionClassName), onMouseEnter: showOnClick ? undefined : showTooltip, onMouseLeave: showOnClick ? undefined : hideTooltip, onClick: showOnClick ? showTooltip : undefined, children: actionElement }), isVisible &&
                ReactDOM.createPortal(_jsxs("div", { ref: tooltipRef, className: cn('absolute', 
...
const TooltipContent = ({ children, className = '', reset = false, ...rest }) => _jsx("div", { className: cn('rounded-md px-2 py-1 text-body2 w-max', reset ? "" : "bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200", className), ...rest, children: children });
