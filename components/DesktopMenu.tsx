  ...
  return (
    <>
      <Link href="/" className="flex">
        <Image src={AspectLogo} width={140} alt="Aspect Logo" className="block dark:hidden" />
        <Image src={AspectDarkLogo} alt="Aspect Logo" width={140} className="hidden dark:block" />
      </Link>
      <NavbarList>
